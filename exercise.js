...
let country = "Bnagladesh";
let population = 166300000;
let continent ="ASIA"
console.log(country);
...
if (population >= average_pop){
    console.log("Bengali's population is above average");
}else{
    console.log("Bengali's population is " + population + " below average");
}
...
// Logical Operators
 ...
 if(population < 50000000 && onCoast == false){
    console.log("you should live in Bengadesh!")
}else{
    console.log("Bengades does not meet your criteria  ");
}
